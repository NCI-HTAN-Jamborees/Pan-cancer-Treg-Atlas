...
intermedf <- file.path(indir, "obj-list-agg.RDS")
...
#merged_seurat[["RNA"]] <- split(merged_seurat[["RNA"]], f = merged_seurat$sourcefile)
# Error in `split()`:
#! The following layers are already split: ‘counts.1’, ‘counts.2’, ‘counts.3’, ‘counts.4’, ‘counts.5’ Please
...
obj.int <- FindClusters(obj.int, resolution = 2, cluster.name = "cca_clusters")
...
obj.hint <- FindClusters(obj.hint, resolution = 2, cluster.name = "harmony_clusters")
